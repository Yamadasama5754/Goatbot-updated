module.exports = {
	config: {
		...
		description: {
			...
			en: "تحرير دور الأمر (الأوامر ذات الدور <2)"
		},
		category: "info",
		guide: {
	...
	langs: {
		...
		en: {
			...
			noChangeRole: "❗ لا يمكن تغيير دور القيادة \"%1\",
			resetRole: "إعادة تعيين دور الأمر \"%1\" إلى الافتراضي",
			changedRole: "تم تغيير دور القيادة \"%1\" to %2"
		}
	},
